from transformers import AutoTokenizer, AutoModelForCausalLM, AutoConfig, BitsAndBytesConfig, AutoImageProcessor
import torch
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto",
    ...
    try:
        ...
        # HF CLIPVisionTower usually carries the underlying config with name_or_path
        vision_tower_name = getattr(getattr(vt, "vision_tower", None), "config", None).name_or_path or vision_tower_name
    except Exception:
        pass
